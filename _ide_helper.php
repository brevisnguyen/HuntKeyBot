...
')
     ...
     */ 
        ...
        {
                        /** @var \Telegram\Bot\BotManager $instance */
         ...
         * @static 
         */ 
        public static function setDefaultBotName($name)
        {
                        /** @var \Telegram\Bot\BotManager $instance */
                        return $instance->setDefaultBotName($name);
        }
                    /**
         * Get a bot instance.
         *
         ...
         *
         * @param \Telegram\Bot\Container $container instance
         * @return \Telegram\Bot\BotManager 
         * @static 
         */ 
        public static function setContainer($container)
        {
